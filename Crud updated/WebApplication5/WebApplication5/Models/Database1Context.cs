...
namespace WebApplication5.Models
{
    public partial class Database1Context : DbContext
    {
        ...
        public virtual DbSet<Database1> Database1 { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=CYG288;Database=Database1;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Database1>(entity =>
            {
